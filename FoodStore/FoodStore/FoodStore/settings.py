...
PAYCHANGU_PUBLIC_KEY = os.environ.get('PAYCHANGU_PUBLIC_KEY', 'pub-live-nQVBz1lqviEBzeUwpnfLmNXwXPPtcFWl')
...
# 10.0.2.2 is how Android emulator reaches your PC's localhost
WEBHOOK_BASE_URL = os.environ.get('WEBHOOK_BASE_URL', 'http://10.0.2.2:8000')
