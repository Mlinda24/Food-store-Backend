...
class CartItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CartItem
        fields = ['id', 'cart', 'menu_item_id', 'menu_item_name', 'menu_item_price', 
...
class CartSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Cart
        fields = ['id', 'user', 'restaurant_id', 'restaurant_name', 'items', 
...
class OrderItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = OrderItem
        fields = ['id', 'order', 'menu_item_id', 'menu_item_name', 'menu_item_price', 
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ['id', 'customer', 'customer_name', 'customer_phone', 'restaurant_id', 
                  'restaurant_name', 'status', 'total_price', 'delivery_address', 
